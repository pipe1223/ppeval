...
from evaluation.visual.legacy.result_gt_reader import EvalFile, load_eval_file
...
def _call_segmentation(y_true: List[Any], y_pred: List[Any], crops: List[Any], class_list: Optional[List[str]]):
    ...
    try:
        from evaluation.visual.legacy.eval_core.segmentation import evaluate_segmentation  # type: ignore
    except Exception:
...
def evaluate_from_ytrue_ypred(
    *,
    ...
    if task in const.SEG_TAGS:
        ...
        try:
            from evaluation.visual.legacy.eval_core.captioning import evaluate_captioning  # type: ignore
        except Exception:
        ...
        try:
            from evaluation.visual.legacy.eval_core.vqa import evaluate_vqa  # type: ignore
        except Exception:
        ...
        try:
            from evaluation.visual.legacy.eval_core.classification import evaluate_classification  # type: ignore
        except Exception:
        ...
        try:
            from evaluation.visual.legacy.eval_core.detection_hbb import evaluate_detection  # type: ignore
        except Exception:
        ...
        try:
            from evaluation.visual.legacy.eval_core.detection_obb import evaluate_detection2  # type: ignore
        except Exception:
