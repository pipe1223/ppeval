...
def _run_combined(pred_path: str, *, iou: float) -> Dict[str, Any]:
    ...
    try:
        from evaluation.visual.legacy.evaluation_combined import evaluate_combined_file  # type: ignore
...
def _run_separate(
    ...
    *,
    ...
    try:
        from evaluation.visual.legacy.evaluation_separated import evaluate_files  # type: ignore
    except Exception as e:
