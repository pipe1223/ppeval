...
try:
    from result_reader import load_results  # type: ignore
except Exception:
    from result_reader_updated import load_results  # type: ignore

# GT reader v2 or v3 if user prefers
try:
    from gt_reader_v2 import load_gt  # type: ignore
except Exception:
    from gt_reader import load_gt  # type: ignore

from tianhuieval import const
    ...
    if task_type in const.CLS_TAGS:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Make sure you replaced tianhuieval/detection.py with the in-memory version."
            ) from e
